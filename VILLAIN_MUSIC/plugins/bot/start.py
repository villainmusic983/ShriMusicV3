...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:3] == "del":
            # TODO: del_plist_msg is not imported/defined anywhere in this
            # codebase snippet - confirm its module path before deploying,
            # or this branch will raise NameError.
        ...
        if name[0:3] == "inf":
            ...
            if not search_results:
                await m.edit_text(_["start_7"] if "start_7" in _ else "No results found for that video.")
                return
